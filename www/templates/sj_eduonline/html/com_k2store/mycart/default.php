                ...
                <tr class="row<?php echo $k; ?>">
                   ...
                   <?php if($this->params->get('show_thumb_cart')) : ?>
                    ...
                    <?php endif; ?>
	                    ...
	                    <?php endif; ?>                        
	                   <?php echo JText::_( "K2STORE_ITEM_PRICE" ); ?>: <span class="cart-price"><?php echo K2StorePrices::number($item->price); ?></span>
                    </td>
            ...
            <tfoot class="k2store-cart-footer" >
             <!-- subtotal -->
               	<tr class="cart_subtotal">
                    <td colspan="2" style="font-weight: bold; text-align: right; text-transform: uppercase;">
