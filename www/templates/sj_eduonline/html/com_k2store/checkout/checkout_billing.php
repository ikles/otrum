...
if(empty($html) || JString::strlen($html) < 5) {
	...
	$html = '<div class="row">
		<div class="col-md-6 col-xs-12">[first_name] [last_name] [phone_1] [phone_2] [company] [tax_number]</div>
		<div class="col-md-6 col-xs-12">[address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
		</div>';
}
