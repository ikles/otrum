...
//we dont have a profile set in the store profile. So use the default one.
	$html = '<div class="row">
	<div class="col-md-6 col-xs-12">[first_name] [last_name] [email] [phone_1] [phone_2] [password] [confirm_password]</div>
	<div class="col-md-6 col-xs-12">[company] [tax_number] [address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
	</div>';
}
...
<div class="row">
<div class="col-xs-12" style="clear: both; padding-top: 15px; border-top: 1px solid #EEEEEE;">
...
<div class="col-xs-12" class="buttons">
