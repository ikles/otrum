...
$html = $this->storeProfile->store_guest_layout;
	...
	if(empty($html) || JString::strlen($html) < 5) {
		...
		$html = '<div class="row">
		<div class="col-md-6 col-xs-12">[first_name] [last_name] [email] [phone_1] [phone_2] [country_id] [zone_id] </div>
		<div class="col-md-6 col-xs-12">[company] [tax_number] [address_1] [address_2] [city] [zip] </div>
		</div>';
	}
...
<div class="buttons row">
  <div class="right col-xs-12 pull-right">
