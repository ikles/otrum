...
if(empty($html) || JString::strlen($html) < 5) {
	...
	$html = '<div class="row">
		<div class="col-md-6 col-xs12">[first_name] [last_name] [phone_1] [phone_2] [country_id] [zone_id]</div>
		<div class="col-md-6 col-xs12">[company] [address_1] [address_2] [city] [zip]</div>
		</div>';
}
