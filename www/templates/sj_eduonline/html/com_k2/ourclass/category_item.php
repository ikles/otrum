...
<div class="catItemView catItemViewlisting group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="catItemBody">
	  ...
	  <div class="catItemIntroText">
	  	<?php echo limit_text($this->item->introtext,25); ?>
	  </div>
	  <?php endif; ?>
