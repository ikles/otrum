...
<div id="k2Container" class="itemViewOurclass<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
            ...
            <div class="itemComments">
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active">
                    ...
                    <!-- Item user comments -->
                       <a class="itemCommentsCounter" href="#iCm" aria-controls="iCm" role="tab" data-toggle="tab"> <span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?></a>
                </li>
                <li role="presentation"><a class="commentLink" href="#iCl" aria-controls="iCl" role="tab" data-toggle="tab"><?php echo JText::_('K2_LEAVE_A_COMMENT') ?></a></li>
              </ul>

              <!-- Tab panes -->
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="iCm">
                ...
                <div role="tabpanel" class="tab-pane" id="iCl">
                    <?php if(
            ...
            <div class="col-md-12">
                ...
                <div class="itemRelated">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 <?php echo ($key%2) ? "odd" : "even"; ?>">
                            <div class="itemRelatedItem">
                            ...
                            <?php 
                                ...
                                $src = $item->image;
                                if (!empty( $src)) {								
                                    $thumb_img = '<img style="width:'.$item->imageWidth.'px;height:auto;" class="itemRelImg" src="'.$src.'" alt="'.K2HelperUtilities::cleanHtml($item->title).'" />';
                            ...
                            <a class="itemRelTitle" href="<?php echo $item->link ?>"><?php echo limit_text($item->title,5); ?></a>
                            <?php endif; ?>
                            ...
                            <div class="itemRelIntrotext"><?php echo limit_text($item->introtext, 28); ?></div>
                            <?php endif; ?>
                            ...
                            <a class="itemRelMore" href="<?php echo $item->link ?>"><?php echo JText::_("K2_READ_MORE"); ?></a>
                        </div></div>
                        <?php endforeach; ?>
                        <div class="clr"></div>
                    </div>
