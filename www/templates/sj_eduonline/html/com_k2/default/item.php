...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemToolbar row">
        <ul class="itemToolbar-left col-md-6">
		...
		<ul class="itemToolbar-right col-md-6">
            ...
            <div class="col-md-12">
                ...
                <div class="itemRelated">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 <?php echo ($key%2) ? "odd" : "even"; ?>">
                            ...
                            <div class="itemDateCreated">
                               <?php echo JText::_("K2_CUSTOM_UPDATE"); ?>  <?php echo JHTML::_('date', $item->created , JText::_('d/m/Y')); ?>
                            </div>
