...
<div class="catItemViewTrainer group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
    ...
    <?php if($this->item->params->get('catItemImage') ): ?>
	  ...
	  <?php endif; ?>
    <div class="catItemViewTrainerIntro">
