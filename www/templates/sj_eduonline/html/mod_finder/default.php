...
$output = '<input type="text" name="q" id="mod-finder-searchword" class="sjk2-search-input search-query input-medium" size="'
	. $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '"'
	. ' placeholder="' . JText::_('TEMPLATE_MOD_FINDER_SEARCH_VALUE') . '"/>';
...
{
	$button = '<button class="btn btn-primary ' . $suffix . ' finder' . $suffix . '" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><i class="fa fa-search"></i></button>';
