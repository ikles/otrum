...
<?php } ?>
	...
	<div class="contact-ajax <?php echo $params->get('moduleclass_sfx')?>" id="<?php echo $tag_id; ?>"><!--<![endif]-->
		<div class="ctajax-wrap">
			<div class="ctajax-element yt-top-map">
				<div class="el-inner">
					<div class="el-map">
						<?php if ($params->get('maps_display') == 1) { ?>
			...
			<div class="ctajax-element">
				<div class="el-inner cf col-md-8">
					<div class="el-form cf">
					<h3 class="modtitle"><?php echo JText::_('TEXT_MESSAGE'); ?></h3>
						<form class="el-ctajax-form" id="el_ctajax_form" method="post" action="#">
							<div class="yt-el-top row">
								<div class="el-control col-md-4">
							...
							<div class="el-control yt-el-bot">
							...
							<div class="el-control el-control-date">
							...
							<?php } ?>
							<div class="el-control el-control-send">
				...
				<div class="el-inner-right col-md-4">
				<?php
					$desc = trim($list->misc);
					if ($desc != '') ?>
					<div class="el-desc">
