...
//    $currency = CurrencyDisplay::getInstance();
    ...
    <div class="moduletable <?php echo $class_suffix; ?>">
        ...
        <div id="<?php echo $tag_id ; ?>"
            ...
            <?php } ?>
            <?php if(isset($list[0]->ctlink)) { ?>
                <div class="item-all-ct">
                    <a href="<?php echo $list[0]->ctlink;?>" <?php echo K2ExtrasliderHelper::parseTarget($params->get('item_link_target')); ?>>
                        <?php echo JText::_('TEMPLATE_VIEW_ALL_COURSES'); ?>
                    </a>     
                </div>
            <?php } ?>
