                        ...
                        <div class="item-wrap-inner">
                            ...
                            <?php if( $options->item_title_display == 1 || $options->item_desc_display == 1 || ( $item->tags != '') || $options->item_readmore_display == 1 ){ ?>
                                <div class="ex-info-left">
                                    ...
                                    <?php } ?>
                                    <?php if(isset($item->numOfComments)){ ?>
                                    <div class="it-comment">
                                        <span class="it-comment-icon"><i class="fa fa-comments-o"></i></span>
                                        <span class="it-comment-number"><?php echo $item->numOfComments; ?></span>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="item-info ex-info-right">
                                    ...
                                    <?php } ?>
                                    <?php if(isset($item->author) || isset($item->categoryname)){?>
                                    <div class="it-au-ct">
                                        <div class="it-au"><?php echo JText::_('TEMPLATE_K2_EXTRASLIDE_BY'); ?><span><?php echo $item->author;?></span></div>
                                        <div class="it-ctname"><?php echo $item->categoryname;?></div>
                                    </div>
                                    <?php } ?>
                                </div>
                            <?php }?>
