...
if ( $this->isRoot() ){
	...
	echo "<li class='level1'> <div class='button meganavigator-close'><i class='fa fa-times button'></i></div> </li>";
    echo "</ul>";
    echo "<button class='btn-meganavigator hidden-sm hidden-xs' type='button'><i class='fa fa-bars'></i></button>
		 
		 <button class='btn-hamburger js-slideout-toggle hidden-lg' type='button'><i class='fa fa-bars'></i></button>";
