...
function testimonial_itemYTShortcode($atts, $content = null){
	...
	$testimonial_item .= '<div class="content_testimon" style="'.($avatar != '' ? "margin-top:15px;" : "").' text-align:center;'.$css.'">';
	$testimonial_item .= '<span class="author">'.$author.'</span> - <small>'.$position.'</small><div class="content">'.parse_shortcode(str_replace(array("<br/>", "<br>", "<br />"), " ", $content)).'</div>';
