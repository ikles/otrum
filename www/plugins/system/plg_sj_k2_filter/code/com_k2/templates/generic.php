...
<div id="k2_Container" class="genericView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">

	<?php if($this->params->get('show_page_title') || JRequest::getCmd('task')=='filter' || JRequest::getCmd('task')=='date'): ?>
		<!-- Page title -->
