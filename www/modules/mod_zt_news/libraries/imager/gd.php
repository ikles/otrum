 ...
 */
if (!class_exists('ZtNewsImagerGd'))
{
     ...
     */
    class ZtNewsImagerGd extends ZtNewsImagerAbstract
    {

        /**
         * Load image from physical file
         * @param string $imageFile
         * @return \ZtNewsImagerGd
         */
