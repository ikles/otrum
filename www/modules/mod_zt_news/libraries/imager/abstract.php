 ...
 */
if (!class_exists('ZtNewsImagerAbstract'))
{

    /**
     * Image process abstract class
     */
    abstract class ZtNewsImagerAbstract extends JObject
    {
        ...
        /**
         * Get ZtNewsImageSizer
         * We will use it calc new image size
         * @return \ZtNewsImagerSizer
         */
        public function getImageSizer()
        {
            $resizer = new ZtNewsImagerSizer($this->getWidth(), $this->getHeight());
            return $resizer;
        }
